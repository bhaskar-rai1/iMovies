  ...
  return (
    <>
      <nav className="header">
        ...
        {menu && (
          <ul className="menu">
            <li>{theme === "dark" ? <IoSunny onClick={toggle} /> : <MdOutlineDarkMode onClick={toggle} />}</li>
            <li onClick={() => { navigate("/"); setQuery(""); }}>
              <HiOutlineHome />
            </li>
            <li>
        ...
        <div className="searchIconsContainer">
          ...
          <ul className="menuItems">
            <li className="item">
              {theme === "dark" ? <IoSunny onClick={toggle} /> : <MdOutlineDarkMode onClick={toggle} />}
            </li>
            <li
              onClick={() => {
                navigate("/");
